...
$('#url-btn'+ increment +'').click(function() {
  ...
  $('#url-btn'+ increment +'').after('<div id="URLok" style="font-weight : normal; color : #838383; font-size : 12px;">L\'adresse a bien été ajoutée.</div>');
